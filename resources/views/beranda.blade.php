...
<html lang="en">
        ...
        <div class="row align-items-center top-bar">
            <div class="col-lg-4 col-md-12 text-center text-lg-start">
                <a href="" class="navbar-brand m-0 p-0">
                    <h1 class="fw-bold text-primary m-0"><i class="fa fa-laptop-code me-0"></i></h1>
                    <img src="img/UKPBJ Logo.png" alt="Logo" width="200" >
                </a>
            </div>
  ...
  <!-- navbar-->
  <nav class="navbar navbar-expand-lg navbar-dark" style= "background-color: #8C0C14;" >
  <div class="container">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="#">Non-Tender</a></li>
            <li><a class="dropdown-item" href="#">E-Purchasing</a></li>
            <li><a class="dropdown-item" href="#">Sirup</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="#">Survey Kepuasan</a></li>
            <li><a class="dropdown-item" href="#">Pusat Pengaduan</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#">Materi/Informasi</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Produk Hukum</a>
        </li>
...
<!--navbar end-->
    ...
    <!-- End -->
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">

                <div class="project-item border rounded h-100 p-4" data-dot="01">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded" src="img/Gambar 1.jpeg" alt="">
                        <a href="img/project-1.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>
                    </div>
                    <h6>Kunjungan Kerja Kabupaten Bondowoso</h6>
                    <span>Tanggal 17 maret 2023 Bagian Pengadaan barang jasa kab. Banyuwangi menerima kunjungan dari kab.Bondowoso</span>
                </div>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item bg-light rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                        <img class="flex-shrink-0 rounded-circle border p-1" src="img/56.jpeg" alt="">
                        <div class="ms-4">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <img class="img-fluid rounded" src="img/Gambar 1.jpeg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="img/Gambar 3.jpeg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="img/Gambar 3.jpeg" alt="Image">
                        </div>
