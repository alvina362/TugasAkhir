    ...
    <div class="card shadow p-3 ">
        ...
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label">Subjek</label>
                <div class="col-md-10">
                    <input id="subjek" type="text" class="form-control" name="subjek" placeholder="Masukkan Subjek Konsultasi">
                </div>
        </div>
        ...
        <div class="mb-3 row">
            <label class="col-sm-2 col-form-label">Isi Konsultasi</label>
                <div class="col-md-10">
                    <textarea id="isi" type="text" class="form-control textarea" name="isi" placeholder="Apa yang ingin anda konsultasikan?"></textarea>
                </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button id="submitBtn" type="submit" class="btn btn-md btn-primary" style="background-color: #8C0C14; border:none">Konsultasikan</button>
    ...
    <script>
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            if (!subjek || !isi || !attachment) {
                ...
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Tindakan Anda telah berhasil dilakukan.',
                    icon: 'success',
                    confirmButtonText: 'OK'
                });
            }
