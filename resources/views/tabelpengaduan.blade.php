...
<div class="container">
        ...
        <div class="container-fluid p-5">
            <div class="card table-responsive shadow p-5" style="border: none">
                <div class="row">
                    <div class="col-lg-3">
                        <a href="/createpengaduan" type="button" class="btn btn-primary mb-3"
                    ...
                    <div class="col-lg-9 d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <a href="#" target="_blank">
                            <img src="avatar.png" class="circle mx-auto"
                    ...
                    <table class="table" style="width:100%;">
                        ...
                        <tbody class="table">
                                        <tr>
                                            ...
                                            <td>2024-06-24</td>
                                            <td>
                                                <span class="badge rounded-pill bg-primary text-light">Sedang di proses</span>
                                            </td>
                                            <td>
